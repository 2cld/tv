...
|---|---|---|---|--|
| [slPlex](http://24.216.208.251:32400/) | christrees | [Plex](https://netstack.org/docs/portals/plex) on sg2 [docs](https://sl.2cld.net/docs) | live in sl | sl->32400->0.6 [doc cfPlex](https://netstack.org/docs/portals/plex#cfPlex) |
| [slDVR](http://24.216.208.251:32500/) | christrees | [Plex](https://netstack.org/docs/portals/plex) on slwin11 [docs](https://sl.2cld.net/docs) | live in sl | sl->32500->0.9 [doc cfDVR](https://netstack.org/docs/portals/plex#cfDVR) |
|---|---|---|---|--|
